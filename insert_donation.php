<?php
	...
	$pickup = $_POST["pickup"];
echo $category."<br>";
	$sql = "INSERT INTO donation(donate_id,donar_name,donar_email,city_id,address,category_id,date,items,discription,pickup) VALUES('".$user_id."','".$name."','".$email."',".$city.",'".$address."','".$category."','".$date."','".$items."','".$discription."','".$pickup."')";
	$q=mysqli_query($con,$sql);
	if($q == 1){?>
                             <script>
	...
	<?php  header("location:./donate.php"); }
